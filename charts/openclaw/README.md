...
[![App Version](https://img.shields.io/badge/App_Version-2026.2.25-blue)](https://github.com/openclaw/openclaw)
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.3.25-blue)](https://github.com/serhanekicii/openclaw-helm)
...
| app-template.openclawVersion | string | `"2026.2.25"` | OpenClaw image version (used by all OpenClaw containers) |
...
The most common cause is **write attempts to read-only paths** — the container can only write to `/home/node/.openclaw` (PVC) and `/tmp` (emptyDir). Everything else is read-only.
