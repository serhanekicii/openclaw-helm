...
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.5.23-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"147.0.7727.117"` | Chromium sidecar image version |
