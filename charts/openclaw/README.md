...
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.5.0-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"146.0.7680.76"` | Chromium sidecar image version |
