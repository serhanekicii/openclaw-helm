...
[![App Version](https://img.shields.io/badge/App_Version-2026.3.8-blue)](https://github.com/openclaw/openclaw)
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.4.6-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"146.0.7680.66"` | Chromium sidecar image version |
...
| app-template.openclawVersion | string | `"2026.3.8"` | OpenClaw image version (used by all OpenClaw containers) |
