...
[![App Version](https://img.shields.io/static/v1?label=App+Version&message=2026.4.29&color=blue)](https://github.com/openclaw/openclaw)
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.5.30-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"148.0.7778.97"` | Chromium sidecar image version |
...
| app-template.openclawVersion | string | `"2026.4.29"` | OpenClaw image version (used by all OpenClaw containers) |
